...
- **Пост-деплой-проверка на живом инстансе (2026-08-30) нашла два дефекта,
  ...
  1. `RegistryRuntime.ensure_initialized()` никогда не материализовал
     ...
     (исправлено `1a249d9`; после переdeploy — файл сеется, идемпотентность
  ...
  Оба дефекта исправлены, прод пересобран и повторно верифицирован:
